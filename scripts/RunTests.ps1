...
$TestOutput = dotnet coverlet "HockeyPickup.Api.Tests/bin/Debug/net9.0/HockeyPickup.Api.Tests.dll" --target "dotnet" --targetargs "test --verbosity normal --no-build" --format lcov --output HockeyPickup.Api.Tests/TestResults/ --threshold=0 --threshold-type=line --threshold-stat=total --exclude-by-file "**.g.cs"
