...
namespace HockeyPickup.Api.Migrations.V2
{
    ...
    [Migration("20260620224552_ActivityLogUserIdOptional")]
    partial class ActivityLogUserIdOptional
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HockeyPickup.Api.Data.Entities.CurrentSessionRoster", b =>
                {
            ...
            modelBuilder.Entity("HockeyPickup.Api.Data.Entities.Session", b =>
                {
                    ...
                    b.Property<bool>("LotteryEnabled")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bit")
                        .HasDefaultValue(true);

                    b.Property<int>("LotteryEntryWindowMinutes")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasDefaultValue(30);
            ...
            modelBuilder.Entity("HockeyPickup.Api.Data.Entities.SessionLotteryEntrant", b =>
                {
                    b.Property<int>("LotteryEntrantId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("LotteryEntrantId"));
                    ...
                    b.HasKey("LotteryEntrantId")
                        .HasName("PK_dbo.SessionLotteryEntrants");
                    ...
                    b.ToTable("SessionLotteryEntrants", (string)null);
            ...
            modelBuilder.Entity("HockeyPickup.Api.Data.Entities.BuySell", b =>
                {
                    ...
                    b.HasOne("HockeyPickup.Api.Data.Entities.AspNetUser", "CreateByUser")
                        .WithMany()
                    ...
                    b.HasOne("HockeyPickup.Api.Data.Entities.AspNetUser", "UpdateByUser")
                        .WithMany()
            ...
            modelBuilder.Entity("HockeyPickup.Api.Data.Entities.Session", b =>
                {
                    ...
                    b.Navigation("CurrentSessionRoster");

                    b.Navigation("LotteryEntrants");
                });
