    ...
    public override async Task<IdentityResult> UpdateAsync(AspNetUser user, CancellationToken cancellationToken = default)
    {
        ...
        try
        {
            ...
            await _context.Database.ExecuteSqlRawAsync(sql,
                ...
                new Microsoft.Data.SqlClient.SqlParameter("@PayPalEmail", user.PayPalEmail ?? (object) DBNull.Value),
                ...
                new Microsoft.Data.SqlClient.SqlParameter("@VenmoAccount", user.VenmoAccount ?? (object) DBNull.Value),
                new Microsoft.Data.SqlClient.SqlParameter("@MobileLast4", user.MobileLast4 ?? (object) DBNull.Value),
